...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:75px;top:9px;" onLoad="modelLoad"><div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="userType" queryAction="queryUsertype" url="/flowapp/flowapp" tableName="usertype" idColumn="fid"><filter name="filter0" xid="filter1"></filter>
  <column label="主键" name="fid" type="String" xid="default4"></column>
  <column label="注册的类型" name="fname" type="String" xid="default5"></column>
  <column label="备注" name="fremark" type="String" xid="default6"></column></div>
  <div component="$UI/system/components/justep/data/baasData" autoLoad="false" xid="userAccount" queryAction="queryAccount_register" saveAction="saveAccount" url="/flowapp/flowapp" tableName="account" idColumn="fid"><column label="主键" name="fid" type="String" xid="default1"></column>
  ...
  <column label="fusertypeid" name="fusertypeid" type="String" xid="default11"></column></div></div>  
